...
class DefaultController extends Controller
{
    ...
    {
        return $this->render( 'FoodPandaCountryBundle:Default:index.html.twig');
    }

    public function showAction()
    {
        $countryList = $this->getList();
        return $this->render( 'FoodPandaCountryBundle:Default:show.html.twig', array( 'list' => $countryList ) );
    }
